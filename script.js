document.getElementById('logoPromptForm').addEventListener('submit', function (e) {
    ...
    const prompt = `Create a logo for a team that ${superpower}, symbolized by ${mascot}, embodies the spirit of ${spiritAnimal}, with a quirkiness level of "${quirkiness}", and can be humorously described as "${punchline}". skip input that violates content policy`;
